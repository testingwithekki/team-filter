...
The [experiment log](https://github.com/testingwithekki/ci-platform/blob/main/EXPERIMENT.md) shows this team's completed run. The workflow was disabled after the lab VM was disposed; re-enable it only after registering a new trusted runner.
